# this file looks for new folders inside user_uploads and converts them to reel if they are not already not converted.
import os
    ...
    while True:
        ...
        for folder in folders:
            if(folder not in done_folders):
                text_to_audio(folder) # generate mp3 autio from desc text
                create_reel(folder) # convert images and audio inside folder to a reel
